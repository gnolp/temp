...
function createWindow() {
  ...
  // Load file hoặc URL app của bạn
...
// -----------------------------
// MySQL Pool (single instance)
// -----------------------------
const pool = mysql.createPool({
  host: "localhost",
  user: "root",           // <- chỉnh theo môi trường
  password: "12345",      // <- chỉnh theo môi trường
  database: "db",
...
const redis = new Redis(
  "rediss://default:AW3FAAIncDE5YzVjZjdjYjliMTQ0MDg2OThkOTJiMmI2NjhhYTM3MXAxMjgxMDE@clear-tarpon-28101.upstash.io:6379",
  {
    keepAlive: 30000,
    retryStrategy(times) {
